...
import howToShipImage from './HowToShip1.jpeg';
        ...
        <div className='container my-5' >
            <div className='row py-5'>
                <div className='col'>
                    ...
                    <Link className='btn btn-info mt-3' to={'/createashipment'}>Ship Now</Link>
                </div>
                <div className='col'>
                    <img src={howToShipImage} alt='HowToShip1' style={{ width: '600px' }} />
                </div>
            </div>
            <div className='container mx-auto my-5' style={{ width: '800px' }}>
                ...
                <div className='row my-5'>
                    ...
                    <div className='col'>
                        ...
                        <Link className='btn btn-outline-info mt-3' to={'/createashipment'}>Create a Shipment</Link>
                    </div>
                </div>
                <div className='row my-5'>
                    <div className='col-1'>
                    ...
                    <div className='col'>
                        ...
                        <p className='lead'>
                            <ul>
                                ...
                                <li>Drop it off at a RapidReach location.</li>
